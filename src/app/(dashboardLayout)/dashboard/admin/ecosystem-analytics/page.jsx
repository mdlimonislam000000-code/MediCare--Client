  ...
  useEffect(() => {
    const fetchAllData = async () => {
      try {
        ...
        const resDoctors = await fetch("http://localhost:5000/api/doctor-posts");
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white dark:bg-[#080c16] p-5 rounded-2xl border border-gray-200 dark:border-white/10 shadow-sm flex items-center justify-between">
          <div>
            <p className="text-xs font-semibold text-gray-400 uppercase">Total Patients visits</p>
        ...
        <div className="bg-white dark:bg-[#080c16] p-5 rounded-2xl border border-gray-200 dark:border-white/10 shadow-sm flex items-center justify-between">
          <div>
            <p className="text-xs font-semibold text-gray-400 uppercase">Verified Clinicians</p>
            <h3 className="text-2xl font-bold mt-1 text-gray-900 dark:text-white">
              {verifiedClinicians}
            </h3>
          </div>
        ...
        <div className="bg-white dark:bg-[#080c16] p-5 rounded-2xl border border-gray-200 dark:border-white/10 shadow-sm flex items-center justify-between">
          <div>
            <p className="text-xs font-semibold text-gray-400 uppercase">All Paitents Bookings</p>
            <h3 className="text-2xl font-bold mt-1 text-gray-900 dark:text-white">
        ...
        <div className="bg-white dark:bg-[#080c16] p-5 rounded-2xl border border-gray-200 dark:border-white/10 shadow-sm flex items-center justify-between">
          <div>
            <p className="text-xs font-semibold text-gray-400 uppercase">Gross Co-Pays</p>
            <h3 className="text-2xl font-bold mt-1 text-gray-900 dark:text-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-[#080c16] p-5 rounded-2xl border border-gray-200 dark:border-white/10 shadow-sm space-y-4">
          ...
          <div className="flex items-center justify-center gap-2 text-xs text-emerald-500 font-semibold pt-1">
            <span className="w-3 h-3 bg-emerald-500 rounded-sm inline-block"></span> Score Rating
          </div>
        </div>
