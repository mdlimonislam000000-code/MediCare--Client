      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center max-w-2xl mx-auto mb-12">
          ...
          <p className="text-base-content/70 text-sm mt-2">
            Have questions about doctors, appointments, or our services? Reach
            out to our 24/7 support team.
          </p>
        </div>
          ...
          <div className="lg:col-span-1 space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium text-base-content mt-0.5">
                      124/A, Green Road, Dhanmondi, Dhaka
                    </p>
                  </div>
                </div>
            ...
            <div className="card bg-error/10 border border-error/20 shadow-lg p-6 space-y-3">
              ...
              <p className="text-xs text-base-content/70">
                Available 24/7 for critical medical support, emergency
                appointments, and ambulance services.
              </p>
            </div>
          </div>
